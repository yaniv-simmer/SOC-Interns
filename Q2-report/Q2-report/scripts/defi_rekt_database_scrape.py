...
class DefiRektScrape:
    def get_page_api_call(self,page=1) -> dict:
        '''
    ...
    def write_page_to_csv(self, data: list) -> None:
        '''
    ...
    def run(self):
        page = 1
        raw_page = self.get_page_api_call(page)
